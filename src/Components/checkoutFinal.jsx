...
const Checkout = () => {
    ...
    const handleSubmit = async (values) => {
        ...
        productos.docs.forEach((doc) => {
            ...
            /* probar doc.data().tamanios.stock */
            ...
            if (stock >= totalCantItem) {
                batch.update(doc.ref, {
                    /* stock: stock - item.cantidad */
                    stock: stock - totalCantItem
                })
            } else {
            ...
            >
                {() => (
                    <Form>
                        ...
                        <Field placeholder="Tu email2" className="form-control my-2" type="email" name="email2"/>
